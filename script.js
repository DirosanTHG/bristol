...
const walkRouteLine = L.polyline(festivalWayRoute, {
...
const busRouteLine = L.polyline(shuttleBusRoute, {
...
// Route show/hide toggles
function wireRouteToggle(btnId, line){
...
wireRouteToggle('toggleWalk', walkRouteLine);
wireRouteToggle('toggleBus', busRouteLine);
